...
2.  Have an AWS S3 bucket to store periodic database backups.

### Steps:

```bash
  git clone https://github.com/Mmust-Ihub/Digiwezo-DB.git

  cd Digiwezo-DB

  cp .env.example .env # Make sure you edit it accordingly

  ./init.sh # Start the cluster.
```
